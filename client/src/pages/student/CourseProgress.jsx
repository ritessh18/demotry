...
const CourseProgress = () => {
  ...
  const [
    completeCourse,
    { data: markCompleteData, isSuccess: completedSuccess , error:New },
  ] = useCompleteCourseMutation();
  const [
    incompleteCourse,
    { data: markInCompleteData, isSuccess: inCompletedSuccess ,error:errorNn},
  ] = useInCompleteCourseMutation();
    ...
    <div className="mt-4 max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4">
          <div className="w-full aspect-video md:rounded-lg overflow-hidden">
            <video
